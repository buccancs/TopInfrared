...
public final class ActivityLocalFilesBinding implements ViewBinding {
  ...
  private ActivityLocalFilesBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnBack,
      @NonNull Button btnClearAll, @NonNull Button btnRefresh, @NonNull LinearLayout layoutHeader,
      @NonNull LinearLayout layoutStats, @NonNull ProgressBar progressLoading,
      @NonNull RecyclerView recyclerViewFiles, @NonNull LinearLayout tvEmptyState,
      @NonNull TextView tvFilesCount, @NonNull TextView tvStorageUsed) {
  ...
  public static ActivityLocalFilesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLocalFilesBinding((ConstraintLayout) rootView, btnBack, btnClearAll,
          btnRefresh, layoutHeader, layoutStats, progressLoading, recyclerViewFiles, tvEmptyState,
          tvFilesCount, tvStorageUsed);
    }
